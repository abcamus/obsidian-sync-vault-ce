...
2. 多设备自动同步
	...
	- 同步第三方插件和主题.
	- markdown文件端到端加密.
3. 云端资源融合：让Obsidian中轻松管理、链接各种云端资源，参考 [网盘超链接功能介绍](https://mp.weixin.qq.com/s/uaChRHt0PIHZfKBwbGBlvg)
<p align="center">
  <img src="./assets/dashboard.webp" alt="看板" width="400" />
</p>

4. 多人协同编辑：分布式多人协同编辑，具备在线文档的编辑体验。


[实时协同编辑演示](https://github.com/user-attachments/assets/85d63239-2c5c-4d73-8774-f4ea2f93f426)
[百度网盘双向同步演示](https://github.com/user-attachments/assets/fbc8c22a-9de2-42c4-b676-753007e5e031)
[点击了解](https://sync-vault.com)更多功能.

## 📱 支持的云服务

| 编号  | 云服务         | 支持的功能                                                                                                                                                                                                                                                                                                                                                                                                                    |
| :-- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1   | 百度网盘        | [多方备份](https://mp.weixin.qq.com/s/zct07eny-LcMTiYjb49k9w)、[受控同步](https://sync-vault.com/sync-mode/restricted-mode.html)、[自动同步](https://sync-vault.com/sync-mode/auto-mode)、[图片在线预览](https://mp.weixin.qq.com/s/ZNxQTnnSNbKcAkkwRndzcQ)、[PDF在线阅读](https://mp.weixin.qq.com/s/WUy6j1hT3nmeSToCWEBg9A)、[视频播放](https://sync-vault.com/more-feature/video-playback)、[音频播放](https://sync-vault.com/more-feature/video-playback)、[网盘超链接](https://mp.weixin.qq.com/s/uaChRHt0PIHZfKBwbGBlvg) |
| 2   | OneDrive    | 多方备份、受控同步、自动同步、图片在线预览、PDF在线阅读，音频在线播放、视频在线播放、网盘超链接                                                                                                                                                                                                                                                                                                                                                                                   |
| 3   | 阿里云盘        | 多方备份、受控同步、自动同步、图片在线预览、PDF在线阅读、音频在线播放、视频在线播放、网盘超链接                                                                                                                                                                                                                                                                                                                                                                                        |
| 4   | 115网盘       | 图片在线预览、PDF在线阅读、音频在线播放、视频在线播放、网盘超链接                                                                                                                                                                                                                                                                                                                                                                                                  |
| 5   | 夸克网盘        | 多方备份、受控同步、自动同步、图片在线预览、PDF在线阅读、网盘超链接                                                                                                                                                                                                                                                                                                                                                                                                     |
| 6   | 腾讯COS       | 多方备份、受控同步、自动同步                                                                                                                                                                                                                                                                                                                                                                                                           |
| 7   | 坚果云         | 多方备份、受控同步、自动同步                                                                                                                                                                                                                                                                                                                                                                                                           |
| 8   | InfiniCloud | 多方备份、受控同步、自动同步                                                                                                                                                                                                                                                                                                                                                                                                           |
| 9   | 123云盘       | 多方备份、受控同步、自动同步                                                                                                                                                                                                                                                                                                                                                                                                           |
